...
public class URLadapter {
    ...
    public static String getHost() {
        return "http://10.0.2.2:8080/TrainArrive/";
    }

    public static String getTicketsFromTieyou(String from, String to, String date) {
        String url = null;
        url = "http://www.tieyou.com/daigou/" + from + "-" + to + ".html?date=" + date;
        return url;
    }
    public static String getTicketsUrl(){
        return "http://trains.ctrip.com/TrainBooking/Ajax/";
    }
}
